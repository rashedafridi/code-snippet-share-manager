defmodule CodeSnippetShareManager.GistsTest do
  use CodeSnippetShareManager.DataCase

  alias CodeSnippetShareManager.Gists

  describe "gists" do
    alias CodeSnippetShareManager.Gists.Gist

    import CodeSnippetShareManager.GistsFixtures
  ...
  describe "saved_gists" do
    alias CodeSnippetShareManager.Gists.SavedGist
